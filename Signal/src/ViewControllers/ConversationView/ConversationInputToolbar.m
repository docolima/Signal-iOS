...
- (void)showApprovalUIForAttachment:(SignalAttachment *)attachment
{
    ...
    [cancelButtonWrapper addRedBorder];
    dispatch_async(dispatch_get_main_queue(), ^{
        NSLog(@"cancelIcon.size: %@", NSStringFromCGSize(cancelIcon.size));
        NSLog(@"cancelIconInset: %f", cancelIconInset);
        NSLog(@"cancelButtonSize: %f", cancelButtonSize);
        NSLog(@"attachmentView: %@", NSStringFromCGRect(attachmentView.frame));
        NSLog(@"cancelButtonSuperview: %@", NSStringFromCGRect(cancelButtonSuperview.frame));
        NSLog(@"cancelButtonWrapper: %@", NSStringFromCGRect(cancelButtonWrapper.frame));
        NSLog(@"cancelButton: %@", NSStringFromCGRect(cancelButton.frame));
    });
    ...
    //                                                 : @"Label for 'send' button in the 'attachment approval'
    //                                                 dialog.")
